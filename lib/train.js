        ...
        return fetchUrl(url, response => {
            ...
            if(travel) {
                ...
                if(travel.from.location.id) {
                    result.start.coordinates = [travel.from.location.coordinate.x, travel.from.location.coordinate.y]
                }
                result.end = {
                ...
                if (travel.to.location.id) {
                    result.end.coordinates = [travel.to.location.coordinate.x, travel.to.location.coordinate.y]
                }
            } else {
                result.duration = 0;
            }
