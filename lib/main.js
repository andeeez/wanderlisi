...
const plan = new Plan(planCallback);
...
function mapMode() {
    ...
    const menu = new Menu(plan, onMenuOpen, onMenuSelect);
    ...
    const map = new Map({selectedTrack: selectedTrackName, onSelect: onFeatureSelect});
