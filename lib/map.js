...
export default class TrackMap {
    ...
    addTrack(trackUrl, callback) {
        ...
        source.on("addfeature", e => {
            ...
            e.feature.set("folder", gpxUrl.substring(0, gpxUrl.lastIndexOf('/') + 1));
        });
                ...
                if (this.processedLayers.indexOf(layer) == -1) {
                    ...
                    features.forEach(feature => {
                        ...
                        if (this.processedLayers.indexOf(layer) == -1 && (type == "LineString" ||
                            ...
                            this.startPinSource.addFeature(first);
                            this.endPinSource.addFeature(last);
                            callback && callback({ folder: feature.get("folder"), features: [feature, first, last]});
    ...
    selectTrack(layer, feature) {
        ...
        this.options.onSelect && this.options.onSelect({ folder: feature.get("folder") });
    }
}
