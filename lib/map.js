...
export default class TrackMap {
                ...
                if (this.processedLayers.indexOf(layer) == -1) {
                    ...
                    features.forEach(feature => {
                        ...
                        if (this.processedLayers.indexOf(layer) == -1 && (type == "LineString" ||
                            ...
                            callback && callback({ featureUrl: feature.get("featureUrl"), name: feature.get("name"), feature, first, last});
    ...
    selectTrack(layer, feature) {
        ...
        this.options.onSelect && this.options.onSelect({ featureUrl: feature.get("featureUrl") });
    }
}
